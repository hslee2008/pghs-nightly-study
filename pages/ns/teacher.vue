    ...
    <v-row justify="center">
      <v-col cols="12" md="6" class="mb-10">
        <v-card flat width="100%">
          <v-card-title class="text-center"><b>야자 1교시</b></v-card-title>
          <v-text-field
            v-model="search1"
      ...
      <v-col cols="12" md="6" class="mb-10">
        <v-card flat width="100%">
          <v-card-title class="text-center"><b>야자 2교시</b></v-card-title>
          <v-text-field
            v-model="search2"
          ...
          >
            <template #item.actions="{ item }">
              <v-menu>
                ...
                <v-list>
                  <v-list-item @click="deleteStudent(2, item)" base-color="red">
                    <v-list-item-title>
                      <v-icon>mdi-delete</v-icon>
                      삭제하기
                    </v-list-item-title>
